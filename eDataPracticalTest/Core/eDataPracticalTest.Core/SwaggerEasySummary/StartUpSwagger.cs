...
/*
 form more: https://github.com/MhozaifaA/SwaggerEasySummary
 */


using eDataPracticalTest.Core.SwaggerEasySummary.Configure;
    ...
    public static class SWSwaggerGenServiceCollectionExtensions
    {
            ...
            this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Version = "2.0",
                    Title ="eData Practical Test" ,//Assembly.GetEntryAssembly().GetName().Name,
                    Description = "API for " + Assembly.GetEntryAssembly().GetName().Name,
                    TermsOfService = new Uri("https://www.edata.digital/"),
                    Contact = new OpenApiContact
                    {
                        Name = "Contact",
                        Url = new Uri("https://www.edata.digital/")
                    },
